...
#ifndef CGAL_Indexed_Triangulation_data_structure_3_H
#define CGAL_Indexed_Triangulation_data_structure_3_H
...
// TODO : noms : Vb != Vertex_base : clarifier.
    ...
    >
    class Indexed_Triangulation_data_structure_3
            : public Triangulation_utils_3 {
        typedef Indexed_Triangulation_data_structure_3<Vb, Cb, Concurrency_tag_, Ih> Tds;
    ...
    public:
        ...
        struct Rebind_vertex {
            typedef Indexed_Triangulation_data_structure_3<Vb2, Cb, Concurrency_tag, Ih> Other;
        };

        template<typename Cb2>
        struct Rebind_cell {
            typedef Indexed_Triangulation_data_structure_3<Vb, Cb2, Concurrency_tag, Ih> Other;
        };
...
//#endif  
    ...
    public:
        Indexed_Triangulation_data_structure_3()
                : _dimension(-2) { }

        Indexed_Triangulation_data_structure_3(const Tds &tds) {
            copy_tds(tds);
        }
        ...
        auto maxId() const { return _indexHandler.maxId(); }
        void disableId() { _indexHandler.disable(); }
        ...
        Cell_handle create_cell() {
            return cells().emplace(_indexHandler);
        }
        ...
        Cell_handle create_cell(Vertex_handle v0, Vertex_handle v1,
            ...
            return cells().emplace(v0, v1, v2, v3, _indexHandler);
        }
        ...
        Cell_handle create_cell(Vertex_handle v0, Vertex_handle v1,
            ...
            return cells().emplace(v0, v1, v2, v3, n0, n1, n2, n3, _indexHandler);
        }
        ...
        Cell_handle create_face(Vertex_handle v0, Vertex_handle v1,
                                Vertex_handle v2) {
            CGAL_triangulation_precondition(dimension() < 3);
            return cells().emplace(v0, v1, v2, Vertex_handle(), _indexHandler);
        }
        ...
        bool flip(const Facet &f) { return flip(f.first, f.second); }
        ...
        bool flip(const Edge &e) { return flip(e.first, e.second, e.third); }
  ...
  Cell_handle create_star_3(Vertex_handle v, Cell_handle c,
    ...
    public:
        ...
        Vertex_handle insert_in_facet(const Facet &f) { return insert_in_facet(f.first, f.second); }

        Vertex_handle insert_in_facet(Cell_handle c, int i);

        Vertex_handle insert_in_edge(const Edge &e) { return insert_in_edge(e.first, e.second, e.third); }
    ...
    public:
        ...
        incident_facets(Vertex_handle v, OutputIterator facets, Filter f = Filter()) const {
            ...
            if (dimension() == 3)
                ...
                return visit_incident_cells<DegCell_as_Facet_extractor<OutputIterator, Filter>, OutputIterator>(v,
                                                                                                                facets,
                                                                                                                f);
        }
        ...
        incident_facets_threadsafe(Vertex_handle v, OutputIterator facets, Filter f = Filter()) const {
            CGAL_triangulation_precondition(dimension() > 1);
            if (dimension() == 3)
                return visit_incident_cells_threadsafe<Facet_extractor<OutputIterator, Filter>, OutputIterator>(v,
                                                                                                                facets,
                                                                                                                f);
            else
                return visit_incident_cells_threadsafe<DegCell_as_Facet_extractor<OutputIterator, Filter>, OutputIterator>(
                        v, facets, f);
        }
        ...
        Vertex_handle copy_tds(const TDS_src &, typename TDS_src::Vertex_handle, const ConvertVertex &,
                               const ConvertCell &);
...
typename Indexed_Triangulation_data_structure_3<Vb,Cb,Ct>::Cell_handle
Indexed_Triangulation_data_structure_3<Vb,Cb,Ct>::
create_star_3(Vertex_handle v, Cell_handle c, int li, int prev_ind2)
{
    ...
    template<class Vb, class Cb, class Ct, class Ih>
    typename Indexed_Triangulation_data_structure_3<Vb, Cb, Ct, Ih>::Cell_handle
    Indexed_Triangulation_data_structure_3<Vb, Cb, Ct, Ih>::
...
//at the moment we made the change it was faster like this.
    ...
    template<class Vb, class Cb, class Ct, class Ih>
    std::istream &
    operator>>(std::istream &is, Indexed_Triangulation_data_structure_3<Vb, Cb, Ct, Ih> &tds)
    // reads :
    // the dimension
    ...
    {
        typedef Indexed_Triangulation_data_structure_3<Vb, Cb, Ct, Ih> Tds;
    ...
    template<class Vb, class Cb, class Ct, class Ih>
    std::ostream &
    operator<<(std::ostream &os, const Indexed_Triangulation_data_structure_3<Vb, Cb, Ct, Ih> &tds)
    // writes :
    // the dimension
    // the number of vertices
    // the number of cells
    ...
    is_simplex(Cell_handle c) const {
        switch (dimension()) {
            ...
            case 2 :
                return is_facet(c, 3);
            case 1 :
                return is_edge(c, 0, 1);
            case 0 :
                return is_vertex(c->vertex(0));
            case -1 :
                return c == cells().begin();
        }
        return false;
    }
    ...
    template<class Vb, class Cb, class Ct, class Ih>
    typename Indexed_Triangulation_data_structure_3<Vb, Cb, Ct, Ih>::Vertex_handle
    Indexed_Triangulation_data_structure_3<Vb, Cb, Ct, Ih>::insert_first_finite_cell(
    ...
    typename Indexed_Triangulation_data_structure_3<Vb, Cb, Ct, Ih>::Vertex_handle
    Indexed_Triangulation_data_structure_3<Vb, Cb, Ct, Ih>::
    insert_in_facet(Cell_handle c, int i) { // inserts v in the facet opposite to vertex i of cell c
    ...
    decrease_dimension(Cell_handle c, int i) {
        ...
        if (dimension() == 1) {
            ...
            c1->set_neighbor(1, n1);
            n1->set_neighbor(i1, c1);
    ...
    template<class Vb, class Cb, class Ct, class Ih>
    typename Indexed_Triangulation_data_structure_3<Vb, Cb, Ct, Ih>::size_type
    Indexed_Triangulation_data_structure_3<Vb, Cb, Ct, Ih>::
...
#endif // CGAL_Indexed_Triangulation_data_structure_3_H
