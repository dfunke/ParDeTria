...
std::string to_string(const dPointStats<D, Precision> &p) {
    std::stringstream o;
    o << "min: " << p.min << " mid: " << p.mid << " max: " << p.max;
    return o.str();
}
...
// 2D
template std::string to_string(const dVector<2, float> &p);
...
template std::string to_string(const dPointStats<2, float> &p);

template std::ostream &operator<<(std::ostream &o, const dVector<2, float> &p);
...
template std::ostream &operator<<(std::ostream &o, const Partition<2, float> &p);

template std::ostream &operator<<(std::ostream &o, const dPointStats<2, float> &p);

// 3D
template std::string to_string(const dVector<3, float> &p);
...
template std::string to_string(const dPointStats<3, float> &p);

template std::ostream &operator<<(std::ostream &o, const dVector<3, float> &p);
...
template std::ostream &operator<<(std::ostream &o, const Partition<3, float> &p);

template std::ostream &operator<<(std::ostream &o, const dPointStats<3, float> &p);

// double

// 2D
template std::string to_string(const dVector<2, double> &p);
...
template std::string to_string(const dPointStats<2, double> &p);

template std::ostream &operator<<(std::ostream &o, const dVector<2, double> &p);

template std::ostream &operator<<(std::ostream &o, const dPoint<2, double> &p);

template std::ostream &operator<<(std::ostream &o,const dSimplex<2, double> &p);
...
template std::ostream &operator<<(std::ostream &o, const Partition<2, double> &p);

template std::ostream &operator<<(std::ostream &o, const dPointStats<2, double> &p);

// 3D
template std::string to_string(const dVector<3, double> &p);
...
template std::string to_string(const dPointStats<3, double> &p);

template std::ostream &operator<<(std::ostream &o, const dVector<3, double> &p);

template std::ostream &operator<<(std::ostream &o, const dPoint<3, double> &p);

template std::ostream &operator<<(std::ostream &o, const dSimplex<3, double> &p);
...
template std::ostream &operator<<(std::ostream &o, const Partition<3, double> &p);

template std::ostream &operator<<(std::ostream &o, const dPointStats<3, double> &p);
