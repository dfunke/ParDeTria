...
for n in N2D:
    ...
    plt.hist(whereUsedSet2[whereUsedSet2['nP'] == n]['nWU'], label='Active')
    plt.hist(whereUsedSet2[whereUsedSet2['nP'] == n]['nIWU'], label='Deleted')
...
for n in N3D:
    ...
    plt.hist(whereUsedSet3[whereUsedSet3['nP'] == n]['nWU'], label='Active')
    plt.hist(whereUsedSet3[whereUsedSet3['nP'] == n]['nIWU'], label='Deleted')
